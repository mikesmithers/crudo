...
as
    ...
    is
    --
    -- Called from the WRITE and ERR procedures to insert the message into 
    -- the APPLICATION_LOGS table.
    -- Uses an autonomous transaction to prevent interference with the
    -- calling transaction.
